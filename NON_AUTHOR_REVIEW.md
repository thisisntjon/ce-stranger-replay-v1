...
Use a fresh clone and only the committed synthetic fixture.
...
Compare both oracle_projection objects. They must match.
...
Return a review decision that names the reviewer and session, binds the exact receipt and oracle hashes, and states the scope. Do not upgrade the result to scientific truth, production readiness, or general efficacy.
