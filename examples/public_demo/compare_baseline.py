...
def main() -> int:
    ...
    result = {
        ...
        "comparison": rows,
        "review_status": "author-run; non-author review pending",
        "limitations": [
    ...
    lines += [
        ...
        "",
        "This is an author-run behavioral comparison. It does not establish semantic truth, general superiority, speed, cost or named non-author acceptance.",
    ]
